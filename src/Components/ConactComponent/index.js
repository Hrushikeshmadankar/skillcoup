...
const ContactComponent = () => {
  const haveBulkOrderBg = {
    backgroundImage:
      "url('https://res.cloudinary.com/skillcoup/image/upload/v1661794453/contact_us/bulk_qs7uw6.jpg')",
  };
  return (
    <>
      <HeaderComponent />
              ...
              <form method="post" name="contactform" autocomplete="on">
                ...
                <div className="input-with-icon-left">
                  <input
                    ...
                    type="text"
                    id="subject"
                    placeholder="Specify in few words"
                    required="required"
                  />
              ...
              <div className="contact-address">
                <ul>
                  ...
                  <li>
                    ...
                    <span className="bold_txt">Location :</span>
                    <p>
                      Pandharpur - 12, Manmatheshwar Housing Society , Link Road
                  ...
                  <li>
                    ...
                    <span className="bold_txt">Phone :</span> <br />
                  ...
                  <li>
                    ...
                    <span className="bold_txt"> Email :</span> <br />
                    &nbsp;{" "}
                  ...
                  <li>
                    <div className="freelancer-socials">
                      <ul>
                        <li>
                          <a
                            href=" https://instagram.com/skillcoup?igshid=wt7x1hn1uinj"
                            title="Instagram"
                        ...
                        <li>
                          <a
                            href="https://twitter.com/skillcoup?s=08"
                            title="Twitter"
                            data-tippy-placement="top"
                          >
                        ...
                        <li>
                          <a
                            href="https://www.facebook.com/skill.coup.7"
                            title="Facebook"
                            data-tippy-placement="top"
                          >
                        ...
                        <li>
                          <a
                            href="https://www.linkedin.com/company/skillcoup"
                            title="LinkedIn"
                            data-tippy-placement="top"
                          >
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-6 col-md-8 col-sm-12 bulk_txt">
                <span
                  className="bold_txt heading_txt"
                  style={{ fontSize: "50px" }}
                >
                  Have a bulk order?
                </span>
                <p style={{ fontWeight: 100 }}>
                  Dont worry! Just give a call to (+91) 9158246012{" "}
                </p>
                <p>
