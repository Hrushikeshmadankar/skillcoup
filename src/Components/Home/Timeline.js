            ...
            >
              ...
              <div className="timeline-step col-xs-4">
                ...
                >
                  ...
                  <p className="h6 text-muted mb-0 mb-lg-0">
                    Tell us about yourself. Build a stronger profile to help
                    yourself find great work.
                  </p>
                </div>
              </div>
              ...
              <div className="timeline-step col-xs-4">
                ...
                >
                  ...
                  <p className="h6 text-muted mb-0 mb-lg-0">
                    Get connected with our clients who need to accomplish their
                    work with the help of your talent.
                  </p>
                </div>
              </div>
              {/* <!-- ----Timeline items---- --> */}
              ...
              <div className="timeline-step col-xs-4">
                ...
                >
                  ...
                  <p className="h6 text-muted mb-0 mb-lg-0">
                    Get connected to share your work and keep a track of the
                    details on the go.
                  </p>
                </div>
              </div>
              ...
              <div className="timeline-step col-xs-4 mb-0">
                ...
                >
                  ...
                  <p className="h6 text-muted mb-0 mb-lg-0">
                    Get paid for your authentic work and have a safe transaction
                    method through our payment system.
                  </p>
                </div>
              </div>
            </div>
